        ...
        try {
            ...
            const loadImage = (src) => {
                return new Promise((resolve, reject) => {
                    const img = new Image();
                    // Removed crossOrigin since images are local assets
                    img.onload = () => {
            ...
            try {
                ...
                // Header Logos
                if (nirmaanLogo) doc.addImage(nirmaanLogo, 'PNG', 20, 10, 25, 10);
                if (samruddhiLogo) doc.addImage(samruddhiLogo, 'PNG', 165, 8, 25, 15);

            } catch (imgError) {
                console.warn("Failed to load logos for receipt, continuing without them:", imgError);
